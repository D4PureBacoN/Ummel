...
import './XD_AnzeigeaufgebenArtikel31.dart';
import './XD_Chat1.dart';
import './XD_TopKomponente.dart';

class XD_Chat11 extends StatelessWidget {
  XD_Chat11({
    Key? key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 165.0, start: 19.0),
            Pin(size: 30.0, middle: 0.8148),
            child:
                // Adobe XD layer: 'Löschen' (group)
                PageLink(
              links: [
                PageLinkInfo(
                  transition: LinkTransition.Fade,
                  ease: Curves.easeOut,
                  duration: 0.3,
                  pageBuilder: () => XD_AnzeigeaufgebenArtikel31(),
                ),
              ],
              child: Stack(
                children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 45.0, middle: 0.2182),
            Pin(size: 18.0, middle: 0.8089),
            child: Text(
              'Galerie',
              style: TextStyle(
                fontFamily: 'Quicksand',
