...
import './XD_Anzeigeanschauen1.dart';
import './XD_Blume.dart';
import './XD_Chat1.dart';
import './XD_MeinProfil.dart';
import './XD_TopKomponente.dart';

class XD_Anzeigeanschauen3 extends StatelessWidget {
  XD_Anzeigeanschauen3({
    Key? key,
  }) : super(key: key);
  @override
                    ...
                    Pinned.fromPins(
                      ...
                      child: Stack(
                        children: <Widget>[
                          ...
                          Pinned.fromPins(
                            Pin(start: 28.0, end: 54.0),
                            Pin(size: 25.0, middle: 0.5402),
                            child: Text(
                            ...
                            child:
                              ...
                              links: [
                                PageLinkInfo(
                                  ...
                                  ease: Curves.easeOut,
                                  duration: 0.3,
                                  pageBuilder: () => XD_Anzeigeanschauen1(),
                                ),
                              ],
                              child: XD_Blume(),
                            ),
                          ...
                          Pinned.fromPins(
                            Pin(size: 171.0, end: 48.0),
                            Pin(size: 67.0, start: 14.0),
                            child:
                                // Adobe XD layer: 'Felder' (group)
                                Stack(
                              children: <Widget>[
                                Pinned.fromPins(
                                  Pin(start: 0.0, end: 0.0),
