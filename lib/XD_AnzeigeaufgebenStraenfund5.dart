...
import 'package:app_ummel/XD_AnzeigeanschauenEigeneAnzeige.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/flutter_svg.dart';

import './XD_TopKomponente.dart';

class XD_AnzeigeaufgebenStraenfund5 extends StatelessWidget {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 0.0, start: 30.0),
            Pin(size: 0.0, end: 103.0),
            child: Text(
              '',
              style: TextStyle(
                fontFamily: 'Quicksand',
